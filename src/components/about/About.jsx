    ...
    <div>
      ...
      <div className='about-container'>
        <div className='my-image'>
          {/* <img src='images/me-min.jpg' className='me-img'> */}
        </div>
        <div className='explain'>
          ...
          スノーボードグッズの販売員を経験後、ワーキングホリデーを利用し、<br/>
          カナダ・バンフ国立公園内のカフェで就業。<br/>
          その後、営業事務を経験し、30歳になる直前で将来を考えたときに、<br/>
          これから進化し続けていくI Tの分野に携わり、自分のアイデアを活かせる仕事がしたい<br/>
          と思うようになり、テックキャンプでプログラミングを学ぶ。<br/>
          現在は転職活動をしながら自走力を活かし、JavaScript・React.jsを学習中。<br/>
          <br/>
          趣味：サーフィン・スノーボード・アクセサリー作り・動画編集<br/>
          <br/>
          関連リンク
